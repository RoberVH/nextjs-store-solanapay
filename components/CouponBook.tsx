...
export default function CouponBook() {
  ...
  return (
    <>
      <div className="flex flex-col bg-blue-900 text-white rounded-md p-1 items-center">
        <p><strong>Collect 5 drinks & receive 50% off next purchase! <strong>🔥🔥🔥</strong></strong></p>
